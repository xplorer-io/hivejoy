...
import { ArrowLeft, Mail, KeyRound, Store } from 'lucide-react';
import { Separator } from '@/components/ui/separator';
import { GoogleIcon, FacebookIcon } from '@/components/shared/icons';
import { useAuth } from '@/hooks/useAuth';

function ProducerAuthContent() {
  const {
    step,
    email,
    otp,
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <CardTitle>Sign In as Producer</CardTitle>
          </div>
          <CardDescription>
            {step === 'email'
              ? 'Sell your authentic Australian honey on Hive Joy'
        ...
        <CardContent>
          ...
          <div className="mt-6 pt-6 border-t">
            ...
            <div className="flex gap-2">
              <Link href="/auth/consumer" className="flex-1">
